 ...
 * 현재 페이지를 가리키는 바
 */
const CurrentLocationBar = styled(motion.span)`
  position: absolute;
  ...
  return (
    <Nav variants={navVariants} initial="top" animate={navAnimation}>
      <Col>
        ...
        <Items>
          <Item>
            <Link to="/">Home {homeMatch && <CurrentLocationBar layoutId="circle" />}</Link>
          </Item>
          <Item>
            <Link to="/tv">Tv Shows {tvMatch && <CurrentLocationBar layoutId="circle" />}</Link>
          </Item>
        </Items>
      </Col>
